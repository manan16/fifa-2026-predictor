  ...
  return (
    <div className="mt-8">
      ...
      <div className="relative h-20">
        ...
        {/* Market marker (sky blue) */}
        <div className="absolute top-1/2 h-10 w-0.5 -translate-x-1/2 -translate-y-1/2 bg-sky-300 opacity-95 transition-all duration-700" style={{ left: `${market}%` }} />
        <span
        ...
        <div className="absolute top-1/2 h-10 w-0.5 -translate-x-1/2 -translate-y-1/2 bg-yellow-300 opacity-90 transition-all duration-700" style={{ left: `${model}%` }} />
